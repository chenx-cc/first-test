...
//     exec(success, error, 'StoreTimerSelector', 'show', [arg0]);
// };

var PLUGIN_NAME = 'StoreTimer';
var StoreTimer = function () { };

StoreTimer.prototype.showSelector = function (options, success_callback, error_callback) {
    options || (options = {});
...
StoreTimer.prototype.show = function (options, success_callback, error_callback) {
...
StoreTimer.prototype.hideSelector = function (success_callback, error_callback) {
    return cordova.exec(success_callback, error_callback, PLUGIN_NAME, 'hideSelector', []);
};

module.exports = new StoreTimer();
